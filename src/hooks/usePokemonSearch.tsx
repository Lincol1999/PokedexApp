...
export const usePokemonSearch = () => {
    ...
    const mapPokemonList = (pokemonList: Result[]) => {
        ...
        setSimplePokemonList(newPokemonList) //Si solo ponemos newPokemonList, obtendriamos solo la ultima pagina
        setIsFetching(false); //Se cancela el loading cuando temine de cargar la pagina 
